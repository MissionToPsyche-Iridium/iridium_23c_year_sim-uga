    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        <section className="mb-8">
          ...
          While the Psyche Spacecraft is yet to reach 16-Psyche, the Psyche Mission will be sure to capture amazing visual and geologic data about the asteroid
          using several cool imaging techniques! The main imaging strategy involes capturing images that cover the entire surface through multiple orbits, using
           both direct nadir and angled off-nadir shots. The strategy sets optimal ranges for illumination, stereo separation, and incidence/emission angles to
            ensure high-quality, overlapping images. These varied viewing geometries support the creation of detailed DTMs and comprehensive maps that capture
             both geological and compositional nuances. Read more about some of the imaging and data gathering techniques used below!
          </p>
        </section>
